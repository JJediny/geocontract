...
| Path                                                       | Purpose                                                                |
| ---------------------------------------------------------- | ---------------------------------------------------------------------- |
| `templates/*.template.schema.json`                         | json-schema-x-graphql annotated JSON Schemas (one per source). Includes `proposed-action` (citizen-initiated). |
...
| **`contracts/groton-rhine-001.datacontract.yaml`**         | **ODCS instance record for a citizen-initiated ProposedAction** (worked example for `docs/plan-citizen-permitting-standard.md`). |
...
| `examples/groton-rhine-001.example.data.json`              | Worked example data for the citizen-initiated `ProposedAction`.         |
...
| `docs/plan-citizen-permitting-standard.md`                 | Implementation plan for the citizen-initiated ProposedAction flow.     |
